    ...
    <div class="container mx-auto">
        <nav class="mt-11 flex flex-col items-center justify-center bg-white md:flex-row md:justify-between md:p-5">
            ...
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <button type="submit" class="rounded-lg bg-[#00AFE7] px-5 py-3 text-lg text-white sm:p-5">Login</button>
            </form>
        </nav>
            ...
            <div class="rounded-2xl border border-[#616161] bg-white px-8 pb-8 drop-shadow">
                ...
                <form>
                    ...
                    <div class="mb-3.5">
                        ...
                        <input type="textarea" class="form-input w-full rounded-md border border-gray-300 p-2 drop-shadow"
                            required>
                    </div>
                    <div class="mb-3.5">
                        <label for="date" class="mb-1 block text-lg text-gray-700">Deadline</label>
                        <input type="date" class="form-input w-full rounded-md border border-gray-300 p-2 drop-shadow"
                            required>
                    </div>
                    <div class="mb-3.5">
